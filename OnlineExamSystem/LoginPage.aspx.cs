...
namespace OnlineExamSystem
{
    public partial class LoginPage : System.Web.UI.Page
    {
        ...
        protected void loginButton_Click(object sender, EventArgs e)
        {
            ...
            //{
            //    //string CS = "Data Source=localhost; Initial Catalog=OnlineExam; User id=sa; Password=SqlServer#2008;";
            ...
            //    //}
            //}
            if (AccountTypeDB.SelectedItem.Text == "Admin")
            {
                if (userTextBox.Text == "CMadmin" && passTextBox.Text == "Cyber@123")
                {                   
